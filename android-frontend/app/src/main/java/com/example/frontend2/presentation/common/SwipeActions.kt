package com.example.frontend2.presentation.common
...
fun SwipeActionsRight(
    ...
    cornerRadius: Dp = 12.dp, itemWidth: Dp = 100.dp,
                ...
                if (numberOfActions == 2) {
                    Surface(
                        ...
                        when (type) {
                            Type.Icon -> {
                                Icon(
                                    imageVector = actionTwoImage, contentDescription = null,
                            ...
                            Type.Text -> {
                                Column(
                                    ...
                                    AnimatedVisibility(
                                        ...
                                        Text(
                                            text = actionTwoText, color = actionTwoColor,
